...
func TestLayout(t *testing.T) {
	...
	for _, this := range []struct {
		...
		// JSON Feed
		{
			"JSON Feed Home", LayoutDescriptor{Kind: "home"}, "", JSONFeedFormat,
			[]string{
				"index.jsonfeed.feed.json",
				"home.jsonfeed.feed.json",
				"jsonfeed.feed.json",
				"list.jsonfeed.feed.json",
				"index.feed.json",
				"home.feed.json",
				"list.feed.json",
				"_default/index.jsonfeed.feed.json",
				"_default/home.jsonfeed.feed.json",
				"_default/jsonfeed.feed.json",
				"_default/list.jsonfeed.feed.json",
				"_default/index.feed.json",
				"_default/home.feed.json",
				"_default/list.feed.json",
				"_internal/_default/feed.json",
			},
		},
		{
			"JSON Feed Section", LayoutDescriptor{Kind: "section", Section: "sect1"}, "", JSONFeedFormat,
			[]string{
				"sect1/sect1.jsonfeed.feed.json",
				"sect1/section.jsonfeed.feed.json",
				"sect1/jsonfeed.feed.json",
				"sect1/list.jsonfeed.feed.json",
				"sect1/sect1.feed.json",
				"sect1/section.feed.json",
				"sect1/list.feed.json",
				"section/sect1.jsonfeed.feed.json",
				"section/section.jsonfeed.feed.json",
				"section/jsonfeed.feed.json",
				"section/list.jsonfeed.feed.json",
				"section/sect1.feed.json",
				"section/section.feed.json",
				"section/list.feed.json",
				"_default/sect1.jsonfeed.feed.json",
				"_default/section.jsonfeed.feed.json",
				"_default/jsonfeed.feed.json",
				"_default/list.jsonfeed.feed.json",
				"_default/sect1.feed.json",
				"_default/section.feed.json",
				"_default/list.feed.json",
				"_internal/_default/feed.json",
			},
		},
